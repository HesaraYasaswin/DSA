...
class SortsTestHarness {
    ...
    private static void usage() {
        System.out.println(" Usage: java SortsTestHarness n xy [xy ...]");
        ...
        System.out.println("           g - quicksort");
        System.out.println("           3 - quicksortmedian3");
        System.out.println("           r - quicksortrandom");
